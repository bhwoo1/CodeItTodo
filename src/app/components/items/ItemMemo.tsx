...
function ItemMemo({item, newMemo, onMemoUpdate}: {item: Item, newMemo: string|null, onMemoUpdate: (memo: string|null) => void}) {
  return (
    <div className="w-11/12 h-[300px] mx-4 lg:mx-0 lg:my-4 lg:w-2/3 lg:h-[400px] bg-[url('/img/memo.png')] bg-cover bg-center rounded-4xl text-center flex flex-col items-center">
